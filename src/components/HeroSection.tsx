    ...
    <section data-component="src/components/HeroSection.tsx" className="relative w-full lg:flex lg:flex-row">
      ...
      <div className="lg:hidden absolute top-0 left-0 right-0" style={{ background: 'linear-gradient(180deg, #F9F4EE 0%, #F2EBE0 100%)' }}>
        <div className="px-6 pt-32 pb-10 sm:px-10">
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="font-sans text-[9px] font-medium uppercase tracking-[0.35em] text-stone-600">PRIVATE ATELIER</span>
          </div>
          <h1 className="font-display text-[2.75rem] font-black uppercase leading-[0.85] tracking-[0.01em] text-stone-800">
            ORIENTAL<br />PEARL
          </h1>
          <p className="mt-1 font-display text-lg font-bold uppercase tracking-[0.35em] text-stone-600">TATTOO</p>
          <p className="mt-4 max-w-xs font-body text-sm leading-relaxed text-stone-600">Where ink meets the eternal.</p>
          <div className="mt-5">
      ...
      <div className="hidden lg:flex absolute inset-0 z-20 pointer-events-none">
        <div className="flex flex-col justify-center w-[50%] px-10 lg:px-14 pb-10">
          ...
          <p className="mt-1 font-display text-2xl font-bold uppercase tracking-[0.30em] text-stone-600 lg:text-3xl">TATTOO</p>
      ...
      <div className="absolute left-[54%] -translate-x-1/2 top-[87%] z-30 hidden lg:block pointer-events-none">
        <div className="relative">
          ...
          <div className="absolute -inset-3 rounded-full border border-stone-400/30" />
          <div className="absolute -inset-5 rounded-full border border-stone-400/15" />
        </div>
      </div>
