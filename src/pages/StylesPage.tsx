  ...
  return (
    <div className="min-h-screen bg-[#F9F4EE] pt-24 pb-16">
      <div className="mx-auto max-w-[84rem] px-6 sm:px-10 lg:px-12">
        ...
        <p className="mt-3 font-body text-sm text-stone-600">Seven disciplines. One standard. Every project begins with the right visual language.</p>
          ...
          {CATEGORIES.map((cat) => {
            ...
            return (
              <Link
                ...
                className="group block border border-stone-300 bg-white/60 overflow-hidden transition hover:border-stone-400"
              >
                ...
                <div className="p-6">
                  ...
                  <p className="mt-2 text-[12px] leading-relaxed text-stone-600">{desc}</p>
                  <div className="mt-4 flex items-center justify-between">
                    <p className="font-sans text-[10px] font-semibold uppercase tracking-[0.14em] text-stone-600">{count} projects</p>
                    <span className="font-sans text-[10px] font-semibold uppercase tracking-[0.14em] text-stone-600 group-hover:text-stone-700 transition-colors">Explore &rarr;</span>
                  </div>
                </div>
              </Link>
            )
